...
export const columnsTableContractItem = (
    ...
    quotationsMap: Record<number, Quotation>, itemsMap: Record<number, SimpleContractItem>
): ColumnDef[] => [
        {
            key: 'stt',
            header: 'STT',
        ...
        },
        {
            ...
            render: (item: ContractItem) => (
                <Typography variant="body2" fontSize={12} fontWeight={600}>
                    {itemsMap[item.quotationItemId]?.contractQty || item.contractQty || 0}
                </Typography>
            ),
        },
        {
            ...
            align: 'right',
            render: (item: ContractItem) => {
                const currentQty = itemsMap[item.quotationItemId]?.contractQty || item.contractQty || 0;
                return (
