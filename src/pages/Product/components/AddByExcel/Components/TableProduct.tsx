...
import type { TableProductProps } from "../Config/types";
import { columns } from "../Config/Columns";



const TableProduct: React.FC<TableProductProps> = ({ rows, imagePreviewMap, categoryMaps }) => {
    ...
    const columnsData = useMemo(() => columns(imagePreviewMap, categoryMaps), [imagePreviewMap, categoryMaps]);
    return (
